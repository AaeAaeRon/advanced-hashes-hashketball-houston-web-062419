...
def num_points_scored(input_players_name)
  game_hash.each do |place, team|
    team.each do |attribute, data|
      next unless attribute == :players
        data.each do |player|
          return player[:points] if player[:player_name] == input_players_name
        end
    end
  end
end
...
def shoe_size(input_players_name)
  game_hash.each do |place, team|
    team.each do |attribute, data|
      next unless attribute == :players
        data.each do |player|
          return player[:shoe] if player[:player_name] == input_players_name
        end
    end
  end
end
...
def team_colors(team_name)
  game_hash.each do |place, team|
    return game_hash[place][:colors] if team_name == team[:team_name]
  end
end 
